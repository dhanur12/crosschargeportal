...
app.post('/delete',(req, res) => {
  let sql = "DELETE FROM viewrequests WHERE transaction_id="+req.body.delete_transaction_id+"";
  let query = conn.query(sql, (err, results) => {
    if(err) throw err;
      res.redirect('/');
  });
